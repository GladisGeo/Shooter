...
def controls_menu():
    ...
    while go == True:
        screen.fill(MAROON)
        draw_text('CONTROLS', gameSubfont, GOLD, screen, SETTINGS.WIDTH/3, 20)
        # draw_text('MOVEMENT', gameMfont, GOLD, screen, SETTINGS.WIDTH/3, 150)
        ...
        draw_text('MOUSE', gameMenufont, GOLD, screen, 110, 260)
        pygame.draw.rect(screen, MAROON, button_2)
        draw_text('KEYBOARD', gameMenufont, GOLD, screen, 110, 330)
        pygame.draw.rect(screen, MAROON, button_3)
        draw_text('CONTOLLER', gameMenufont, GOLD, screen, 110, 400)
