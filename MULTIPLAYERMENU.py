...
def mp_menu():
    ...
    while go == True:
        screen.fill(MAROON)
        draw_text('MULTI PLAYER', gameSubfont, GOLD, screen, SETTINGS.WIDTH/3, 20)
        ...
        draw_text('MATCHMAKING', gameMenufont, GOLD, screen, 110, 260)
        pygame.draw.rect(screen, MAROON, button_2)
        draw_text('CUSTOM MATCH', gameMenufont, GOLD, screen, 110, 330)
        
        pygame.draw.rect(screen, MAROON, button_3)
        draw_text('TEAM CAREER', gameMenufont, GOLD, screen, 110, 400)
