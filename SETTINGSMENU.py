...
def settings_menu(mainMenu):
     
    click = False
    go=True
    while go == True:
        screen.fill(MAROON)
        draw_text('SETTINGS', gameSubfont, GOLD, screen, SETTINGS.WIDTH/3, 20)
        ...
        draw_text('CONTROLS', gameMenufont, GOLD, screen, 110, 260)
        pygame.draw.rect(screen, MAROON, button_2)
        draw_text('DISPLAY', gameMenufont, GOLD, screen, 110, 330)
        pygame.draw.rect(screen, MAROON, button_3)
        draw_text('DIFFICULTY', gameMenufont, GOLD, screen, 110, 400)
