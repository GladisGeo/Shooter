...
def sp_menu():
    ...
    while go == True:
        screen.fill(MAROON)
        draw_text('SINGLE PLAYER', gameSubfont, GOLD, screen, SETTINGS.WIDTH/3, 20)
        ...
        draw_text('TRAINING', gameMenufont, GOLD, screen, 110, 260)
        pygame.draw.rect(screen, MAROON, button_2)
        draw_text('CAREER', gameMenufont, GOLD, screen, 110, 330)
        pygame.draw.rect(screen, MAROON, button_3)
        draw_text('QUICK MATCH', gameMenufont, GOLD, screen, 110, 400)
